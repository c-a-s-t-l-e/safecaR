...
head(complaints)
```
Besides this file, more information like listing all available years, makes, models, and model variants can be found at [safecaR's website](https://c-a-s-t-l-e.github.io/safecaR/).
